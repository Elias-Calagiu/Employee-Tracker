...
INSERT INTO roles (title, salary, department_id) VALUE ("Head of Sales",70000, 1 );
INSERT INTO roles (title, salary, department_id) VALUE ("Director of Marketing", 80000, 2);
INSERT INTO roles (title, salary, department_id) VALUE ("Accountant", 60000, 3);
